...
namespace winrt::Logic_Playground::implementation
{
	struct MainPage : MainPageT<MainPage>
	{
		...
		void EIIRTID0Changed(IInspectable CR, TextChangedEventArgs CR);
		void EIIRTID0Finished(IInspectable CR, KeyRoutedEventArgs CR args);
		void EIIRTID1Changed(IInspectable CR, TextChangedEventArgs CR);
		void EIIRTID1Finished(IInspectable CR, KeyRoutedEventArgs CR args);
		void EIIRTID2Changed(IInspectable CR, TextChangedEventArgs CR);
		void EIIRTID2Finished(IInspectable CR, KeyRoutedEventArgs CR args);
		void EIIRTID3Changed(IInspectable CR, TextChangedEventArgs CR);
		void EIIRTID3Finished(IInspectable CR, KeyRoutedEventArgs CR args);
		void EIIRTidAChanged(IInspectable CR, TextChangedEventArgs CR);
		void EIIRTidAFinished(IInspectable CR, KeyRoutedEventArgs CR args);
		void EIIRTidBChanged(IInspectable CR, TextChangedEventArgs CR);
		void EIIRTidBFinished(IInspectable CR, KeyRoutedEventArgs CR args);
		void EIIRTConfirm(IInspectable CR, RoutedEventArgs CR);
